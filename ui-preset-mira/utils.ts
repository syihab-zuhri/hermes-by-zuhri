...
/** Mira / Modern UI font presets (shadcn b1ZzrZbpw) */
export const themedFont = "font-sans";

/** Mira body copy — clean sentence-case text. */
export const themedBody = "font-sans normal-case";

/** Mira brand chrome — crisp modern headings and labels. */
export const themedChrome = "font-sans font-medium tracking-tight";
